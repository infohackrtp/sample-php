     ...
     <style amp-custom>
        ...
        *,
        ...
        :root:not(#a):not(#a) .md {
            ...
            background-image: url(https://i.ibb.co/x2TzYnC/banner-pendek-37.jpg)
        }

        :root:not(#a):not(#a) .nd {
            background-color: #555656;
            background-image: url(https://i.ibb.co/BghZ3Yw/banner-pendek-3.jpg)
        }

        :root:not(#a):not(#a) .od {
            background-color: #555656;
            background-image: url(https://i.ibb.co/G02dhJK/banner-pendek-14.jpg)
        }

        :root:not(#a):not(#a) .pd {
            background-color: #555656;
            background-image: url(https://i.ibb.co/pWwbzRd/banner-pendek-34.jpg)
        }

        :root:not(#a):not(#a) .qd {
            background-color: #555656;
            background-image: url(https://i.ibb.co/mXHXWVK/banner-pendek-39.jpg)
        }

        :root:not(#a):not(#a) .rd {
            background-color: #555656;
            background-image: url(https://i.ibb.co/Y0G9QSz/banner1.jpg)
        }
...
<body>
    <amp-sidebar id="sidebar" layout="nodisplay" side="left" class="i-amphtml-layout-nodisplay" hidden="hidden"
        ...
        <amp-img class="amp-close-image i-amphtml-layout-fixed i-amphtml-layout-size-defined"
            src="/close-icon.webp" width="20" height="20" alt="close sidebar"
    ...
    <div class="hc">
        <nav class="j o q ic">
            <div class="t p ab"> <button class="l a" type="button" on="tap:sidebar.toggle"
                ...
                <div class="b jc">
                    <div class="kc"> <a class="k lc" href="https://slebew.bio/">
                            <div class="mc">
                                <amp-img src="https://i.ibb.co/9cDg6QQ/mesa168-logo.png" alt="logo" width="127" height="35" layout="fixed" class="nc amp-wp-enforced-sizes i-amphtml-layout-fixed i-amphtml-layout-size-defined" style="width:127px;height:35px;" i-amphtml-layout="fixed"><noscript> <img src="https://i.ibb.co/9cDg6QQ/mesa168-logo.png" alt="logo" width="127" height="35" class="nc"></noscript></amp-img>
                            </div>
                        </a> </div>
                </div>
            </div>
    ...
    <div id="q">
        <div class="v">
            <div class="x qc">
                <a href="https://mesasukses.online/?ref=jancuk" target="_blank"><button type="button" id="r" class="y a" style="font-weight: 900; background: radial-gradient(circle, rgba(254,0,0,1) 0%, rgba(181,6,24,1) 49%, rgba(120,11,11,1) 100%);">DAFTAR</button></a>
                <a href="https://mesasukses.online/?ref=anjayy" target="_blank"><button type="button" class="z a" style="font-weight: 900;background: radial-gradient(circle, rgba(254,0,0,1) 0%, rgba(181,6,24,1) 49%, rgba(120,11,11,1) 100%);">LOGIN</button></a>
            </div>
        </div>
        <div class="b">
            <div class="tc">
                ...
                <div class="c r">
                    <div class="d f xb"><a href="https://slebew.bio/"><button type="button" class="lb a md"
                                id="z" aria-label="interactive-button-1"><span class="mb">interactive-button-1</span></button></a></div>
                    <div class="d f xb"><a href="https://slebew.bio/"><button type="button" class="lb a nd"
                                id="ab" aria-label="interactive-button-2"><span class="mb">interactive-button-2</span></button></a></div>
                    <div class="d f xb"><a href="https://slebew.bio/"><button type="button" class="lb a od" 
                                id="bb" aria-label="interactive-button-3"><span class="mb">interactive-button-3</span></button></a></div>
                    <div class="d f xb"><a href="https://slebew.bio/"><button type="button" class="lb a pd"
                                id="cb" aria-label="interactive-button-4"><span class="mb">interactive-button-4</span></button></a></div>
                    <div class="d f xb"><a href="https://slebew.bio/"><button type="button" class="lb a qd"
                                id="db" aria-label="interactive-button-5"><span class="mb">interactive-button-5</span></button></a></div>
                    <div class="d f xb"><a href="https://slebew.bio/"><button type="button" class="lb a rd" 
                                id="eb" aria-label="interactive-button-5"><span class="mb">interactive-button-6</span></button></a></div>
                </div>
    ...
    <div class="rb wd">
        ...
        <div class="tb">Copyright <a href="https://slebew.bio/">Tingkat Kemenangan MESA168</a> 2023. All rights reserved.</div>
    <div class="cc s qc">
        <div id="qb" class="b">
            <div class="c zb ic">
                <div class="xb be">
                    <a class="i" href="https://cheatslot23.pages.dev/"> <amp-img src="https://i.ibb.co/P5Tb1DD/ikon-home.png" width="20" height="25" layout="fixed" class="ce nc amp-wp-enforced-sizes i-amphtml-layout-fixed i-amphtml-layout-size-defined" style="width:20px;height:25px" i-amphtml-layout="fixed" alt="home"><noscript><img src="https://i.ibb.co/P5Tb1DD/ikon-home.png" width="20" height="25" class="ce nc" alt="home"></noscript></amp-img>
                        <div class="bc"><span class="ac">HACK RTP</span></div>
                    </a>
                </div>
                <div class="xb be">
                    <a class="i" href="https://mesasukses.online/?ref=jancuk" target="_blank"> <amp-img src="https://i.ibb.co/2qVKJ0B/regis-ikon.png" width="20" height="25" layout="fixed" alt="daftar" class="ce nc amp-wp-enforced-sizes i-amphtml-layout-fixed i-amphtml-layout-size-defined" style="width:20px;height:25px;" i-amphtml-layout="fixed"><noscript><img src="https://i.ibb.co/2qVKJ0B/regis-ikon.png" width="20" height="25" alt="daftar" class="ce nc"></noscript></amp-img>
                    <div class="bc"><span class="ac">DAFTAR</span></div>
                    </a>
                </div>
                <div class="xb be">
                    <a class="i" href="https://wa.me/6282114348326" target="_blank" rel="noopener noreferrer"> <amp-img src="https://i.ibb.co/MB6cYMV/promo-ikon.png" width="20" height="25" layout="fixed" class="ce nc amp-wp-enforced-sizes i-amphtml-layout-fixed i-amphtml-layout-size-defined" style="width:20px;height:25px;" i-amphtml-layout="fixed" alt="Whatsapp"><noscript><img src="https://i.ibb.co/MB6cYMV/promo-ikon.png" width="20" alt="Whatsapp" height="25" class="ce nc"></noscript></amp-img>
                        <div class="bc"><span class="ac">WHATSAPP</span></div>
                    </a>
                </div>
                <div class="xb be">
                    <a class="i" href="https://direct.lc.chat/14531859/" target="_blank" rel="noopener noreferrer"> <amp-img src="https://i.ibb.co/3ySSBYq/livechat-ikon.png" width="20" height="25" layout="fixed" alt="live chat" class="ce nc amp-wp-enforced-sizes i-amphtml-layout-fixed i-amphtml-layout-size-defined" style="width:20px;height:25px;" i-amphtml-layout="fixed"><noscript><img src="https://i.ibb.co/3ySSBYq/livechat-ikon.png" width="20" height="25" alt="live chat" class="ce nc"></noscript></amp-img>
